...
enum ProvisioningEndpoint {
    ...
    var path: String {
        ...
        case .registerBaseStation(let deviceId):
            return "api/v1/SensorSuiteProvisioning/RegisterBaseStation/\(deviceId)"
        case .registerMonitor(let wearableId, let guid):
            return "api/v1/SensorSuiteProvisioning/RegisterMonitor/\(guid)/\(wearableId)"
        case .getCertificateRevocationList(let facilityId):
            return "api/v1/SensorSuiteProvisioning/crl/\(facilityId)"
        case .getAvailableBed:
            return "api/v1/SensorSuiteProvisioning/BaseStation/GetAvailableRoomBeds"
        case .getConfig(let facilityId):
            return "api/v1/SensorSuiteProvisioning/BaseStation/GetSensorSuiteConfig/\(facilityId)"
        case .addPatient:
            return "api/v1/SensorSuiteProvisioning/BaseStation/AddPatient"
        case .endSession:
            return "api/v1/SensorSuiteProvisioning/BaseStation/EndSession"
        case .addPatch:
            return "api/v1/SensorSuiteProvisioning/BaseStation/AddPatch"
        case .getUnitRooms:
