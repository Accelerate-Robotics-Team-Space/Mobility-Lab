...
public enum Performance: PerformanceProtocol {
    public static func currentCPUUsagePercent() -> Double {
        var totalUsageOfCPU: Double = 0.0
        // var threadsList = UnsafeMutablePointer(mutating: [thread_act_t]())
        let threads = [thread_act_t]()
        var threadsList = threads.withUnsafeBufferPointer {
            UnsafeMutablePointer(mutating: $0.baseAddress!) // swiftlint:disable:this force_unwrapping
        }
