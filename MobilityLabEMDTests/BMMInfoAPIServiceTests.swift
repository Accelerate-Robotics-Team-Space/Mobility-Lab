...
final class BMMInfoAPIServiceTests: XCTestCase {
    ...
    func testFetchBMMList() async throws {
        ...
        XCTAssertEqual(
            ...
            "\(NetworkingConstants.baseUrlStr)api/v1/MobilityLabProvisioning/GetUnitMobilityMonitor/Test%20ID"
        )
    ...
    func testFetchBMMStatuses() async throws {
        ...
        XCTAssertEqual(
            request?.url?.absoluteString,
            "\(NetworkingConstants.baseUrlStr)api/v1/MobilityLabProvisioning/GetEMDReconnect/Test%20ID"
        )
    ...
    func testFetchAnalytics() async throws {
        ...
        XCTAssertEqual(
            request?.url?.absoluteString,
            "\(NetworkingConstants.baseUrlStr)api/v1/MobilityLabProvisioning/GetEMDAnalytics/LastDayFromTheDate"
        )
