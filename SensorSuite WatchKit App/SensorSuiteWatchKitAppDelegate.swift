//
//  SensorSuiteWatchKitAppDelegate.swift
//
...
class SensorSuiteWatchKitAppDelegate: NSObject, WKApplicationDelegate {
...
extension SensorSuiteWatchKitAppDelegate: WKExtendedRuntimeSessionDelegate {
