...
struct SquareIndicatorShape: Shape {
    ...
    func path(in rect: CGRect) -> Path {
        ...
        path.addLines([CGPoint(x: rect.minX, y: rect.maxY - indicatorLength),
                       CGPoint(x: rect.minX, y: rect.maxY),
                       CGPoint(x: rect.minX + indicatorLength, y: rect.maxY), ])

        path.move(to: CGPoint(x: rect.midX, y: rect.midY))
        path.addLines([CGPoint(x: rect.maxX, y: rect.minY + indicatorLength),
                       CGPoint(x: rect.maxX, y: rect.minY),
                       CGPoint(x: rect.maxX - indicatorLength, y: rect.minY), ])

        path.move(to: CGPoint(x: rect.midX, y: rect.midY))
        path.addLines([CGPoint(x: rect.maxX, y: rect.maxY - indicatorLength),
                       CGPoint(x: rect.maxX, y: rect.maxY),
                       CGPoint(x: rect.maxX - indicatorLength, y: rect.maxY), ])

        path.move(to: CGPoint(x: rect.midX, y: rect.midY))
        path.addLines([CGPoint(x: rect.minX, y: rect.minY + indicatorLength),
                       CGPoint(x: rect.minX, y: rect.minY),
                       CGPoint(x: rect.minX + indicatorLength, y: rect.minY), ])

        path.move(to: CGPoint(x: rect.midX, y: rect.midY))
        path.addLines([CGPoint(x: rect.midX - indicatorLength, y: rect.minY),
                       CGPoint(x: rect.midX + indicatorLength, y: rect.minY), ])

        path.move(to: CGPoint(x: rect.midX, y: rect.midY))
        path.addLines([CGPoint(x: rect.midX - indicatorLength, y: rect.maxY),
                       CGPoint(x: rect.midX + indicatorLength, y: rect.maxY), ])

        path.move(to: CGPoint(x: rect.midX, y: rect.midY))
        path.addLines([CGPoint(x: rect.minX, y: rect.midY - indicatorLength),
                       CGPoint(x: rect.minX, y: rect.midY + indicatorLength), ])

        path.move(to: CGPoint(x: rect.midX, y: rect.midY))
        path.addLines([CGPoint(x: rect.maxX, y: rect.midY - indicatorLength),
