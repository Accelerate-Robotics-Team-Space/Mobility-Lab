...
protocol EMDUserDefaultsServiceProtocol: UserDefaultsServiceProtocol {
...
extension Container {
    var userDefaults: Factory<EMDUserDefaultsServiceProtocol> {
        self { UserDefaultsService() }.cached
    }
}

final class UserDefaultsService: EMDUserDefaultsServiceProtocol {
